...
describe('Journal service: ', () => {
    ...
    const testJournals: Journal[] = [
        ...
        },
        {
            ...
            'Depression is much more than sadness, it varies from person to person and even with age but has some common symptoms. Somedates psychological problems can cause depression and somedates it depends on the day to day life of an individual where they experience depressed mood, loss of interest, feeling of guilt etc. More than 25% of patients suffering with depression are suffering with Psychotic depression. People with mental disorders like schizophrenia also experience mental depression.\n' +
            '\n' +
